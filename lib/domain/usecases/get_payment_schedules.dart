...
class GetPaymentSchedules
    implements UseCase<List<PaymentSchedule>, GetPaymentScheduleParams> {
  final CenturyPropertiesRepository _repo;

  GetPaymentSchedules(this._repo);

  @override
  Future<Either<Failure, List<PaymentSchedule>>> call(
          GetPaymentScheduleParams params) async =>
      await _repo.getPaymentSchedule(
...
class GetPaymentScheduleParams extends Equatable {
